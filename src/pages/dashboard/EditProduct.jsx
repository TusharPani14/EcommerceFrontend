                    ...
                    {attributes.map((attribute, index) => (
                      <div key={index} className=" grid grid-cols-5 gap-1">
                        ...
                        <input
                          ...
                          type="file"
                          multiple={"true"}
                          className=" w-full mt-1 dark:text-gray-400 text-[#4F5D77] bg-[#f2f2f2] text-[14.4px] dark:bg-white/10"
                                      ...
                                      <div key={index} className=" ">
                                        <div className="relative grid grid-cols-5 gap-1">
                                          <IoClose
                                            ...
                                            className=" cursor-pointer rounded-full absolute right-0 bg-orange-300"
                                          />
                                          <input
                                            name={`attributeValue${index}`}
                                            placeholder="Value"
